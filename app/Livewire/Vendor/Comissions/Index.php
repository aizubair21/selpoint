...
class Index extends Component
{
    ...
    {
        $takes = TakeComissions::where([$this->query_for => $this->qry, 'confirmed' => true])->whereDate('created_at', $this->date)->paginate(100);
        $gives = ResellerResellProfits::where('to', Auth::id())->paginate(100);

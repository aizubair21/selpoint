                ...
                <div class="" id="navbarSupportedContent">
                    <ul class="flex items-center">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 mx-2  border rounded text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            ...
                            <x-slot name="content">
                                ...
                                {{-- <x-dropdown-link href="{{route('carts.view')}}" class="mr-3">
                                    <button type="button" class="btn relative">
                                        ...
                                        <span id="displayCartItem"
                                            class="ml-3 absolute top-0 start-100 translate-middle badge rounded-lg">
                                ...
                                <x-dropdown-link class="bold" target="_blank" :href="route('dashboard')">
                                    <i class="fas fa-home pr-2"></i> Go To Dashboard
                                </x-dropdown-link>
                                @else

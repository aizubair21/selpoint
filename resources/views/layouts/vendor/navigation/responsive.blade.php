<x-responsive-nav-link href="{{route('my-shop', ['user' => Str::slug(auth()->user()->name)])}}" :active="request()->routeIs('my-shop')">
...
<x-responsive-nav-link href="{{route('vendor.products.create')}}" :active="request()->routeIs('vendor.products.create')">

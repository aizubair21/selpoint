<div>
    ...
    <x-dashboard.page-header>
        <div class="text-xs">
            {{-- {{ $shopArray['created_at']->toFormattedDateString()}} - last update {{ carbon::parse($shopArray['updated_at'])->diffForHumans() }} --}}
        </div>
        <br>
    ...
    <x-dashboard.container>
        <x-dashboard.section>
            ...
            <main wire:ignore>
                ...
                <input type="hidden" name="content" id="my_input" wire:model.live="shopArray.description" value="{{$shopArray['description']}}" >
                ...
                <div class="md:flex w-full flex-1 gap-10">
                    <div class="p-3 bg-gray-100 rounded-md shadow-sm w-full">
                        ...
                        <div class="text-md border-b w-full p-3">
                            ...
                            {{-- <input type="text" class="w-full border-0 outline-0 ring-0" wire:model.live="shopArray.id"> --}}
                        </div>
                        <div class="text-md border-b w-full p-3">
                    ...
                    <div class="p-3 bg-gray-100 rounded-md shadow-sm w-full">
                        ...
                        <div class="text-md border-b w-full p-3">
                            ...
                            <input type="text" class="w-full border-0 outline-0 ring-0" wire:model="shopArray.shop_name_en">
                        </div>
                        
                        <div class="text-md border-b w-full p-3">
                            <div class="font-bold">Shop Email: </div> 
                            {{-- <div> {{$shopArray['email'] ?? "N/A"}} </div> --}}
                            <input type="text" class="w-full border-0 outline-0 ring-0" wire:model="shopArray.email">
                        </div>
                        <div class="text-md border-b w-full p-3">
                            <div class="font-bold">Shop Phone: </div> 
                            {{-- <div> {{$shopArray['phone'] ?? "N/A"}} </div> --}}
                            <input type="text" class="w-full border-0 outline-0 ring-0" wire:model="shopArray.phone">
                        </div>
                        <div class="text-md border-b w-full p-3">
                            <div class="font-bold">Shop Address: </div> 
                            {{-- <div> {{$shopArray['address'] ?? "N/A"}}  </div> --}}
                            <input type="text" class="w-full border-0 outline-0 ring-0" wire:model="shopArray.address">
                        </div>
                        <div class="text-md border-b w-full p-3 space-y-2">
                            ...
                            <div class="my-1">
                                ...
                                <input type="text" id="vil" class="w-full border-0 outline-0 ring-0" wire:model="shopArray.village" placeholder="village">
                            </div>

                            <div class="my-1">

                                <label class="my-1" for="zip">Zip</label>
                                <input type="text" id="zip" class="w-full border-0 outline-0 ring-0" wire:model="shopArray.zip" placeholder="zip">
                            </div>

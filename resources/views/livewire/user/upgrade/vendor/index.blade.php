        ...
        <x-dashboard.section.header>
            ...
            <x-slot name="content">
                <div class="flex justify-between">
                    <div>
                        Upgrade your account to revenew money. To make a new request
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <x-nav-link
                                        href="{{route('upgrade.vendor.edit', ['upgrade' => 'vendor' , 'id' => $vr->id])}}">
                                        {{$vr->shop_name_en}}
                                    </x-nav-link>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <x-nav-link
                                        href="{{route('upgrade.vendor.edit', ['upgrade' => 'reseller','id' => $vr->id])}}">
                                        {{$vr->shop_name_en}}
                                    </x-nav-link>

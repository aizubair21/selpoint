        ...
        <x-dashboard.section>
            <x-dashboard.section.inner>
                ...
                <x-input-file label="You Fixed Address" name="fixed_address" error="fixed_address" class="block">
                    <p class="text-xs">
                        Your permanent address based on NID. This address will be used for verification purposes. We use
                        this address to verify your location and provide better service.
                    </p>
                    <textarea wire:model.live="fixed_address" class="w-full" id=""
                ...
                <x-input-file label="You Current Address" name="current_address" error="current_address">
                    ...
                    <textarea wire:model.live="current_address" class="w-full" id=""

            ...
            <div class="flex justify-between items-start">
                ...
                <div>
                    <x-dashboard.section class="w-full">
                        <x-input-field inputClass="w-full" label="Page Name" wire:model.live="name" name="name"
                            error="name" />
                        <div class="flex items-center text-gray-600">
                            /page/
                            <x-text-input wire:model.live="slug" name="slug" class="p-0 border-0" />
                        </div>
                    </x-dashboard.section>

                    <x-dashboard.section>
                        <x-input-field inputClass="w-full" label="Page Title" wire:model="title" name="title"
                            error="title" />
                        <x-input-field inputClass="w-full" label="Page Keyword" name="keyword" wire:model="keyword"
                            error="keyword" />
                        <textarea name="description" id="description" placeholder="Description " class="w-full rounded"
                            rows="3"></textarea>
                        <hr>
                        ...
                        <div style="width: 300px; height:100px">
                            ...
                            <img src="{{asset('storage/'.$thumbnail) }}" style="width: 300px; height:100px" alt=""
                                class="border rounded ">
                            @else
                            <img src="{{$thumbnail->temporaryUrl()}}" style="width: 300px; height:100px" alt=""
                                class="border rounded ">
                            @endif
                            @endif
                        </div>
                        <div class="relative w-full">
                            ...
                            <input type="file" wire:model.live="thumbnail" name="" class="absolute hidden top-0"
                                id="thumbnail">
                            <label for="thumbnail">
                ...
                <x-dashboard.section style="width: 300px">
                    ...
                    <x-dashboard.section.inner>
                        ...
                        <a href="{{route('system.pages.create', ['page' => $item->slug])}}"
                            class="flex justify-between items-center border-b py-2 px-1" :active="$page == $item->slug">
                            <div>

                ...
                <x-slot name="title">
                    <div class="flex justify-between items-start px-5">
                        <div class="order-info">
                            ...
                            {{-- <x-nav-link-btn href="{{route('vendor.order.cprint', ['order' => $order->id])}}">Print</x-nav-link-btn> --}}
                            {{-- <a target="_blank" href="{{route('admin.order.print')}}" class="btn btn-sm btn-outline-primary"> <i class="fas fa-print pe-2"></i> Print</a>
                            <a target="_blank" href="{{route('admin.order.print', ['id' => $order->id, 'target' => 'excel'])}}" class="btn btn-sm btn-outline-primary"> <i class="fab fa-excel pe-2"></i> Excel</a> --}}
                        ...
                        <div class="order-total text-end">
                            <table class="table">
                                ...
                                <p>
                                    <strong>{{ $order->user?->name ?? "Not Found !" }} <br> </strong> {{$order->location}}
                                    <br>

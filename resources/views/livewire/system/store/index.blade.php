                                ...
                                <div class="px-3 mt-1 row m-0 align-items-start">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="px-2 rounded bg-success text-white fw-bold ms-2">{{ $strack->where('to', '!=', 'admin')->sum('amount') }} Coins</div>
                                        </div>
                                        <hr>
                                            ...
                                            @if ($st->to != 'admin')
                                                ...
                                                <div class="d-flex p-2 mb-1 alert alert-info d-block" >
                                                    ...
                                                    @if ($st->to == 'admin')
                                                        ...
                                                        <div >
                                                            You Store {{$st->amount}}TK to {{$st->to != 'admin' ? $st->to : 'server'}} <br> - {{$st->info}}
                                                        </div>
                                        
                                                    @else
                                                        <div class="">
                                                            You give {{$st->amount}}TK comission to {{$st->to != 'admin' ? $st->to : 'server'}} <br> - {{$st->info}}
                                                        </div>
                                                    @endif
                                                </div>
